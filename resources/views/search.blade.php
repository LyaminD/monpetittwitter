                ...
                <div class="content">
                        ...
                        <div class="row justify-content-center my-4">
                            <div class="col">
                                <div class="d-flex flex-lg-row flex-column-reverse no-gutters justify-content-center">
                                    ...
                                    <div class="col pr-lg-5"><img class=" img-1 mr-lg-5 " src="images/{{ $tweet->imageprofil }}" alt="..." width="130" class="rounded mb-2 img-thumbnail"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card-footer text-center border-0 mt-0 pt-0 mb-3">
                        <div class="row text-center name mt-auto ">
                            <div class="col">
                                <h4 class="mb-0">{{ $tweet->tweetname}}</h4>
